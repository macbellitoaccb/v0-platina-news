...
import { removeNews } from "@/app/actions"

interface DeleteNewsPageProps {
  params: {
    id: string
  }
}

export default function DeleteNewsPage({ params }: DeleteNewsPageProps) {
